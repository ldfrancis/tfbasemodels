...
def conv2d_bn(filters, kernel_size, strides=(1, 1), padding='valid', data_format=None,
    ...
    kernel_constraint=None, bias_constraint=None, axis=-1, momentum=0.99, epsilon=0.001, center=True, scale=True,
    ...
    **kwargs):
    ...
    def _op(x):
        ...
        x = tf.keras.layers.Conv2D(filters, kernel_size, strides=strides, padding=padding, data_format=data_format,
                                    ...
                                    kernel_constraint=kernel_constraint, bias_constraint=bias_constraint,name=conv_name)(x)
        x = tf.keras.layers.BatchNormalization(axis=axis, momentum=momentum, epsilon=epsilon, center=center, scale=scale,
                                    ...
                                    fused=fused, trainable=trainable, virtual_batch_size=virtual_batch_size, adjustment=adjustment, name=conv_name,
                                    )(x)
